...
export const FETCH_TOP_50_COIN_LIST_REQUEST = "FETCH_TOP_50_COIN_LIST_REQUEST";
export const FETCH_TOP_50_COIN_LIST_SUCCESS = "FETCH_TOP_50_COIN_LIST_SUCCESS";
export const FETCH_TOP_50_COIN_LIST_FAILURE = "FETCH_TOP_50_COIN_LIST_FAILURE";
